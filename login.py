...
# Définition des profils et de leurs accès
DROITS_ACCES = {
...
# Injection du style CSS pour la mise en page
st.markdown("""
    <style>
...
# --- MODULE DE NAVIGATION ---
    ...
    with c1:
        if "Performance" in pages_autorisees:
            # Marqueur invisible pour le CSS
    ...
    with col_btn:
        # Pas de marqueur ici, il prendra la couleur grise par défaut définie dans le CSS
